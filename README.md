...
### 4.1 架构图
单Master架构
![avatar](https://gitlab.wengegroup.com/blubell20/ansible-install-k8s/-/raw/master/single-master.jpg)

多Master架构
![avatar](https://gitlab.wengegroup.com/blubell20/ansible-install-k8s/-/raw/master/multi-master.jpg)
